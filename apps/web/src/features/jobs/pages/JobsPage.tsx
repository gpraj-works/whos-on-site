...
import { Eye, MapPin, Plus, RefreshCw, Search, UserCheck, XCircle } from 'lucide-react'
...
import { useCancelJob, useJobs } from '../api/jobQueries'
...
export const JobsPage: React.FC = () => {
  ...
  // Fetch jobs with server status filter if selected
  const statusFilter =
  ...
  // Client-side search filtering across customer name, address, notes, tech name
  ...
  return (
    <Container size="xl" py="lg">
      <Stack gap="lg">
        <PageHeader
          title={t('nav.jobs', 'Dispatch Board')}
          subtitle={t('jobs.subtitle', 'Manage job assignments, status state machine, and customer dispatches')}
          actions={
            <Group gap="xs">
              <Button
                variant="default"
          ...
          <Table highlightOnHover verticalSpacing="sm" horizontalSpacing="md">
            <Table.Thead>
              <Table.Tr>
                ...
                <Table.Th>{t('jobs.scheduledAt', 'Scheduled At')}</Table.Th>
